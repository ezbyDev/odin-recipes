This project is the first one in TOPs curriculum. It's meant to show if I've learned all the concepts before this project, that being basic "Git" usage and most about common "HTML".
